...
> 来源：迁移前 IMPLEMENTATION_STATUS.md 原第 221–258 行；原条目状态保留，不因迁移改判。
...
- 数据库 server/data/qa-gameplay-round2.sqlite3，账号25/角色24，完整性 ok；升级备份 evidence/2026-09-12/runtime-recovery/pre-reference-v021.sqlite3。升级使内存 session 失效，需刷新并重新登录。
...
- 固定配置 evidence/2026-09-12/runtime-snapshots/gameplay-round2.json、map-round2.json、shared/maps.json；保留账号/存档与唯一bot。
