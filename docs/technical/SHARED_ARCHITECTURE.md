...
对应仓库与固定提交见 `../../evidence/2026-09-05/reference-evidence/repository-inventory.json`。此处是源码审核与方案建议，没有运行第三方游戏，没有声称这些 demo 已可完整联机。
...
文档导航：[计划](../plan/PLAN.md) · [前端](FRONTEND_ARCHITECTURE.md) · [后端](BACKEND_ARCHITECTURE.md) · [验收标准](ARCHITECTURE_ACCEPTANCE.md) · [参考项目分级](REFERENCE_PROJECTS.md)

## 本地审核证据

本仓库内的证据：[固定提交与资源统计](../../evidence/2026-09-05/reference-evidence/repository-inventory.json)（可直接打开）。
