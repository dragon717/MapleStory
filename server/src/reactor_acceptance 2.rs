    ...
    Map {
        ...
        reactors: vec![
            ReactorPlacement {
                ...
                hitbox_lt: None,
                hitbox_rb: None,
                // A deterministic table (no `chance` → always drops) so the
                // use-up payout can be asserted without probabilistic flake.
                drop_table: Some(DropInput::One(DropSpec {
            ...
            ReactorPlacement {
                ...
                // No drop table: the herb breaks but yields nothing.
                drop_table: None,
            },
        ],
    }
