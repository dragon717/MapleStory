...
已检索到项目此前的 `00_RESEARCH_AND_REMAKE_PLAN.md` 与相关 `README.md`。已有建议采用：
...
**P01｜此前项目资料：`00_RESEARCH_AND_REMAKE_PLAN.md`。** 通过文件库检索核对了 Commands → 权威模块 → Committed Events → Views/Replication 的建议链路。该资料本身是设计计划，不是运行代码。
