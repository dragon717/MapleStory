...
for(const script of ['assemble_tms273','index_client_assets','check_tms273_ride_scenes','check_tms273_notebook','check_tms273_sprite_status'])run(process.execPath,[`scripts/${script}.cjs`]);
