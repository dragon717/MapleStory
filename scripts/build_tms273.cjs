...
for(const script of ['export_tms273_avatar','export_tms273_inventory','export_tms273_combat','export_tms273_chat','export_tms273_skills','export_tms273_skill_ui','export_tms273_npc_marker','export_tms273_mage_effects','export_tms273_character_ui','export_tms273_creation_items','export_tms273_entry','export_tms273_avatar_parts','export_tms273_skill_sounds','export_tms273_levelup','export_tms273_chapter','assemble_tms273'])run(process.execPath,[`scripts/${script}.cjs`]);
